		...
		<div class="row">
			...
			<div class="span10">
				<div class="input deposit">
					<div class="title">${message("member.deposit.recharge")}</div>
					<form id="inputForm" action="${base}/payment" method="post" target="_blank">
						<input type="hidden" name="type" value="DEPOSIT_RECHARGE" />
						<table class="input">
							<tr>
								<th>
							...
							<tr>
								<th>
									${message("member.deposit.rechargeAmount")}:
								</th>
								<td>
									<input type="text" id="rechargeAmount" name="rechargeAmount" class="text" maxlength="16" onpaste="return false;" />
								</td>
							</tr>
							<tr>
								<th>
									${message("member.deposit.paymentPlugin")}:
								</th>
								<td>
