...
<body>
	<div class="breadcrumb">
		${message("admin.orderShipping.view")}
	</div>
	<ul id="tab" class="tab">
		<li>
	...
	<table class="input tabContent">
		<tr>
			...
			<td>
				${orderShipping.createdDate?string("yyyy-MM-dd HH:mm:ss")}
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			...
			<td>
				${currency(orderShipping.freight, true)!"-"}
			</td>
		</tr>
		<tr>
			<th>
	...
	<table class="item tabContent">
		...
		[#list orderShipping.orderShippingItems as orderShippingItem]
			<tr>
				<td>
					${orderShippingItem.sn}
				</td>
				<td>
					<span title="${orderShippingItem.name}">${abbreviate(orderShippingItem.name, 50, "...")}</span>
				</td>
				<td>
					${orderShippingItem.quantity}
				</td>
				<td>
					${message(orderShippingItem.isDelivery?string('admin.common.true', 'admin.common.false'))}
				</td>
			</tr>
		[/#list]
	</table>
