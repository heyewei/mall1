		...
		<table class="input">
			...
			<tr class="permissions">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="permissions" value="admin:productNotify" />${message("admin.role.productNotify")}
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="permissions">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="permissions" value="admin:deposit" />${message("admin.role.deposit")}
						</label>
						<label>
			...
			<tr class="permissions">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="permissions" value="admin:statistics" />${message("admin.role.statistics")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:memberStatistic" />${message("admin.role.memberStatistic")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:orderStatistic" />${message("admin.role.orderStatistic")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:memberRanking" />${message("admin.role.memberRanking")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:productRanking" />${message("admin.role.productRanking")}
						</label>
					</span>
				</td>
			</tr>
