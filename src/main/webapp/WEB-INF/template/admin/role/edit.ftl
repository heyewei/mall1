		...
		<table class="input">
			...
			<tr class="permissions">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="permissions" value="admin:productNotify"[#if role.permissions?seq_contains("admin:productNotify")] checked="checked"[/#if] />${message("admin.role.productNotify")}
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="permissions">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="permissions" value="admin:deposit"[#if role.permissions?seq_contains("admin:deposit")] checked="checked"[/#if] />${message("admin.role.deposit")}
						</label>
						<label>
			...
			<tr class="permissions">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="permissions" value="admin:statistics"[#if role.permissions?seq_contains("admin:statistics")] checked="checked"[/#if] />${message("admin.role.statistics")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:memberStatistic"[#if role.permissions?seq_contains("admin:memberStatistic")] checked="checked"[/#if] />${message("admin.role.memberStatistic")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:orderStatistic"[#if role.permissions?seq_contains("admin:orderStatistic")] checked="checked"[/#if] />${message("admin.role.orderStatistic")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:memberRanking"[#if role.permissions?seq_contains("admin:memberRanking")] checked="checked"[/#if] />${message("admin.role.memberRanking")}
						</label>
						<label>
							<input type="checkbox" name="permissions" value="admin:productRanking"[#if role.permissions?seq_contains("admin:productRanking")] checked="checked"[/#if] />${message("admin.role.productRanking")}
						</label>
					</span>
				</td>
			</tr>
