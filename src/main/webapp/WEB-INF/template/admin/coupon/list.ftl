...
<body>
	<div class="breadcrumb">
		${message("admin.coupon.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as coupon]
				<tr>
					...
					<td>
						<a href="generate?id=${coupon.id}">[${message("admin.coupon.generate")}]</a>
						<a href="edit?id=${coupon.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
