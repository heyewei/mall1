...
public class IndexController {
	...
	public String index(ModelMap model) {
		...
		model.addAttribute("marketableProductCount", productService.count(null, true, null, null, null, null));
		model.addAttribute("notMarketableProductCount", productService.count(null, false, null, null, null, null));
		model.addAttribute("stockAlertProductCount", productService.count(null, null, null, null, null, true));
		model.addAttribute("outOfStockProductCount", productService.count(null, null, null, null, true, null));
