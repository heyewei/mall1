...
public class ProductNotifyController extends BaseController {
	...
	public String list(Integer pageNumber, @CurrentUser Member currentUser, Model model) {
		...
		model.addAttribute("page", productNotifyService.findPage(currentUser, null, null, null, pageable));
	...
	public ResponseEntity<?> list(Integer pageNumber, @CurrentUser Member currentUser) {
		Pageable pageable = new Pageable(pageNumber, PAGE_SIZE);
		return ResponseEntity.ok(productNotifyService.findPage(currentUser, null, null, null, pageable).getContent());
	}
