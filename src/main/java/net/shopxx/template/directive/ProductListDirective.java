...
public class ProductListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<Product> products = productService.findList(type, productCategoryId, brandId, promotionId, productTagId, attributeValueMap, startPrice, endPrice, true, true, null, null, null, hasPromotion, orderType, count, filters, orders, useCache);
